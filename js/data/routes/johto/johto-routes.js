...
Object.assign(ROUTE_DATA, {
    ...
    trainer: [
      {
        name: ENTRENADORES.EntrenadorJoven.name, img: ENTRENADORES.EntrenadorJoven.img, rate: 30, pokemon: [
          { name: POKEMON.sentret, minLv: 3, maxLv: 5, moveId: MOVES.normal.physical.tackle },
        ]
      },
      {
        name: ENTRENADORES.EntrenadorJoven.name, img: ENTRENADORES.EntrenadorJoven.img, rate: 15, pokemon: [
          { name: POKEMON.sentret, minLv: 3, maxLv: 4, moveId: MOVES.normal.physical.tackle },
          { name: POKEMON.hoppip, minLv: 3, maxLv: 5, moveId: MOVES.grass.special.absorb },
        ]
      },
      {
        name: ENTRENADORES.EntrenadorJoven.name, img: ENTRENADORES.EntrenadorJoven.img, rate: 15, pokemon: [
          { name: POKEMON.pidgey, minLv: 3, maxLv: 5, moveId: MOVES.flying.physical.peck },
          { name: POKEMON.hoothoot, minLv: 3, maxLv: 5, moveId: MOVES.flying.special.gust },
        ]
      },
      {
  ...
  'ruta-46': {
    ...
    wild: [
      { name: POKEMON.jigglypuff, rate: 25, minLv: 5, maxLv: 7, moveId: MOVES.fairy.special.disarming_voice },
      { name: POKEMON.geodude, rate: 25, minLv: 5, maxLv: 7, moveId: MOVES.rock.physical.rock_throw },
      { name: POKEMON.phanpy, rate: 25, minLv: 5, maxLv: 7, moveId: MOVES.ground.physical.bulldoze },
      { name: POKEMON.houndour, rate: 25, minLv: 5, maxLv: 7, moveId: [MOVES.fire.physical.fire_fang, MOVES.dark.physical.bite] },
    ],
    trainer: [],
    paths: [
  ...
  'ruta-30': {
    ...
    wild: [
      { name: POKEMON.spinarak, rate: 25, minLv: 7, maxLv: 10, moveId: MOVES.bug.physical.bug_bite },
      { name: POKEMON.ledyba, rate: 25, minLv: 7, maxLv: 10, moveId: MOVES.bug.physical.bug_bite },
      { name: POKEMON.caterpie, rate: 25, minLv: 7, maxLv: 10, moveId: MOVES.bug.physical.bug_bite },
      { name: POKEMON.weedle, rate: 25, minLv: 7, maxLv: 10, moveId: MOVES.bug.physical.bug_bite },
    ],
    trainer: [
      {
        name: ENTRENADORES.Cazabichos.name, img: ENTRENADORES.Cazabichos.img, rate: 33, pokemon: [
          { name: POKEMON.caterpie, minLv: 7, maxLv: 11, moveId: MOVES.bug.physical.bug_bite },
          { name: POKEMON.caterpie, minLv: 7, maxLv: 11, moveId: MOVES.bug.physical.bug_bite },
        ]
      },
      {
        name: ENTRENADORES.EntrenadorJoven.name, img: ENTRENADORES.EntrenadorJoven.img, rate: 33, pokemon: [
          { name: POKEMON.pidgey, minLv: 7, maxLv: 11, moveId: MOVES.flying.physical.peck },
          { name: POKEMON.rattata, minLv: 7, maxLv: 11, moveId: MOVES.normal.physical.tackle },
        ]
      },
      {
  ...
  'ciudad-malva-gym': {
    ...
    trainer: [
      {
        name: ENTRENADORES.Ornitologo.name, img: ENTRENADORES.Ornitologo.img, rate: 33, pokemon: [
          { name: POKEMON.pidgey, minLv: 13, maxLv: 15, moveId: MOVES.flying.physical.peck },
        ]
      },
      {
        name: ENTRENADORES.Ornitologo.name, img: ENTRENADORES.Ornitologo.img, rate: 33, pokemon: [
          { name: POKEMON.spearow, minLv: 13, maxLv: 15, moveId: MOVES.flying.physical.peck },
        ]
      },
      {
    ...
    gym: {
      leader: [
        { name: POKEMON.pidgey, level: 17, moveId: MOVES.flying.physical.peck },
        {
  ...
  'ruta-32': { //Ruta 32
    ...
    wild: [
      { name: POKEMON.mareep, rate: 15, minLv: 13, maxLv: 15, moveId: [MOVES.electric.special.thunderbolt, MOVES.normal.physical.tackle] },
      { name: POKEMON.hoppip, rate: 15, minLv: 13, maxLv: 15, moveId: [MOVES.grass.special.absorb, MOVES.fairy.special.disarming_voice] },
      { name: POKEMON.bellsprout, rate: 15, minLv: 13, maxLv: 15, moveId: [MOVES.grass.special.absorb, MOVES.poison.special.poison_powder] },
      { name: POKEMON.ekans, rate: 15, minLv: 13, maxLv: 15, moveId: MOVES.poison.physical.poison_sting },
      { name: POKEMON.gastly, rate: 15, minLv: 13, maxLv: 15, moveId: [MOVES.poison.special.poison_powder, MOVES.ghost.special.hex] },
      { name: POKEMON.wooper, rate: 15, minLv: 13, maxLv: 15, moveId: [MOVES.water.special.water_gun, MOVES.ground.special.mud_shot] },
      { name: POKEMON.tentacool, rate: 10, minLv: 13, maxLv: 15, moveId: [MOVES.water.physical.waterfall, MOVES.poison.physical.poison_sting] },
    ],
    trainer: [
      {
        name: ENTRENADORES.Ornitologo.name, img: ENTRENADORES.Ornitologo.img, rate: 20, pokemon: [
          { name: POKEMON.pidgey, minLv: 13, maxLv: 15, moveId: [MOVES.flying.physical.peck, MOVES.normal.physical.tackle] },
          { name: POKEMON.pidgey, minLv: 13, maxLv: 15, moveId: [MOVES.flying.physical.peck, MOVES.normal.physical.tackle] },
          { name: POKEMON.spearow, minLv: 13, maxLv: 15, moveId: [MOVES.flying.physical.peck, MOVES.normal.physical.tackle] },
        ]
      },
      {
        name: ENTRENADORES.Nadador.name, img: ENTRENADORES.Nadador.img, rate: 25, pokemon: [
          { name: POKEMON.poliwag, minLv: 13, maxLv: 18, moveId: MOVES.water.special.water_gun },
          { name: POKEMON.politoed, minLv: 13, maxLv: 18, moveId: MOVES.water.special.scald },
        ]
      },
      {
        name: ENTRENADORES.ChicaGuay.name, img: ENTRENADORES.ChicaGuay.img, rate: 25, pokemon: [
          { name: POKEMON.nidoran_f, minLv: 13, maxLv: 19, moveId: MOVES.poison.physical.poison_sting },
        ]
      },
      {
        name: ENTRENADORES.Dominguera.name, img: ENTRENADORES.Dominguera.img, rate: 30, pokemon: [
          { name: POKEMON.rattata, minLv: 13, maxLv: 18, moveId: MOVES.normal.physical.tackle },
          { name: POKEMON.zubat, minLv: 13, maxLv: 18, moveId: MOVES.poison.physical.poison_sting },
        ]
      },
    ],
  },
  ...
  'ruinas-alfa': { //Ruinal alfa
    ...
    wild: [
      { name: POKEMON.natu, rate: 30, minLv: 16, maxLv: 20, moveId: [MOVES.psychic.special.confusion, MOVES.flying.special.gust] },
      { name: POKEMON.smeargle, rate: 30, minLv: 16, maxLv: 20, moveId: MOVES.normal.physical.tackle },
      { name: POKEMON.wooper, rate: 30, minLv: 16, maxLv: 20, moveId: [MOVES.water.special.water_gun, MOVES.ground.special.mud_shot] },
      { name: POKEMON.unown, rate: 10, minLv: 16, maxLv: 20, moveId: MOVES.psychic.special.confusion },
    ],
    trainer: [
      {
        name: ENTRENADORES.Caballero.name, img: ENTRENADORES.Caballero.img, rate: 70, pokemon: [
          { name: POKEMON.geodude, minLv: 16, maxLv: 21, moveId: [MOVES.ground.physical.bulldoze, MOVES.rock.physical.rock_throw] },
          { name: POKEMON.geodude, minLv: 16, maxLv: 21, moveId: [MOVES.ground.physical.bulldoze, MOVES.rock.physical.rock_throw] },
        ]
      },
      {
        name: ENTRENADORES.Caballero.name, img: ENTRENADORES.Caballero.img, rate: 30, pokemon: [
          { name: POKEMON.girafarig, minLv: 18, maxLv: 22, moveId: [MOVES.normal.special.swift, MOVES.psychic.special.confusion] },
        ]
      },
    ],
  },
  ...
  'pueblo-azalea-gym': {
    ...
    trainer: [
      {
        name: ENTRENADORES.ChicoGuay.name, img: ENTRENADORES.ChicoGuay.img, rate: 50, pokemon: [
          { name: POKEMON.rattata, minLv: 17, maxLv: 19, moveId: MOVES.normal.physical.tackle },
      ...
      },
      {
        name: ENTRENADORES.Cazabichos.name, img: ENTRENADORES.Cazabichos.img, rate: 50, pokemon: [
          { name: POKEMON.kakuna, level: 20, moveId: MOVES.bug.physical.bug_bite },
    ...
    gym: {
      leader: [
        { name: POKEMON.metapod, level: 22, moveId: MOVES.bug.physical.bug_bite, overrides: { evs: { hp: 32, def: 32, spd: 32, spe: 32, atk: 32 } }, },
        { name: POKEMON.kakuna, level: 22, moveId: MOVES.bug.physical.bug_bite, overrides: { evs: { hp: 32, def: 32, spd: 32, spe: 32, atk: 32 } }, },
        {
          name: POKEMON.scyther, level: 24,
  ...
  'camino-ciudad-trigal': {
    ...
    specialTrainer: {
      name: ENTRENADORES.Plata.name, img: ENTRENADORES.Plata.img, pokemon: [
        { name: POKEMON.gastly, level: 24, moveId: [MOVES.poison.special.sludge_bomb, MOVES.ghost.special.shadow_ball], overrides: { evs: { hp: 32, def: 32, spd: 32, spe: 32, atk: 32 } }, },
        { name: POKEMON.zubat, level: 23, moveId: [MOVES.bug.physical.bug_bite, MOVES.flying.physical.wing_attack], overrides: { evs: { hp: 32, def: 32, spd: 32, spe: 32, atk: 32 } }, },
        { name: 'RIVAL_STARTER_2', heldItem: ITEM.assault_vest, minLv: 24, maxLv: 26, overrides: { evs: { hp: 32, def: 32, spd: 32, spe: 32, atk: 32 } }, },
      ]
    },
    paths: [
      [{ type: PATH_TYPE.Special }],
    ...
    trainer: [
      {
        name: ENTRENADORES.Cazabichos.name, img: ENTRENADORES.Cazabichos.img, rate: 100, pokemon: [
          { name: POKEMON.butterfree, minLv: 23, maxLv: 27, moveId: MOVES.bug.special.infestation },
          { name: POKEMON.ariados, minLv: 23, maxLv: 27, moveId: MOVES.bug.physical.x_scissor },
        ]
      }
    ],
  },
    ...
    trainer: [
      {
        name: ENTRENADORES.Chica.name, img: ENTRENADORES.Chica.img, rate: 100, pokemon: [
          { name: POKEMON.teddiursa, minLv: 23, maxLv: 27, moveId: MOVES.normal.physical.hyper_fang, overrides: { evs: { hp: 32, def: 32, spd: 32, spe: 32, atk: 32 } }, },
          { name: POKEMON.smeargle, minLv: 23, maxLv: 27, moveId: MOVES.normal.physical.tackle, overrides: { evs: { hp: 32, def: 32, spd: 32, spe: 32, atk: 32 } }, },
        ]
      }
    ],
    gym: {
  ...
  'ruta-36-arbol': {
    ...
    rewardPokemon: [],
    wild: [
      { name: POKEMON.sudowoodo, rate: 100, minLv: 31, maxLv: 35, moveId: MOVES.rock.physical.rock_slide },
    ],
    trainer: [],
    paths: [
      [{ type: PATH_TYPE.Wild }],
    ...
    trainer: [
      {
        name: ENTRENADORES.Medium.name, img: ENTRENADORES.Medium.img, rate: 40, pokemon: [
          { name: POKEMON.abra, level: 33, moveId: MOVES.psychic.special.psychic },
          { name: POKEMON.abra, level: 33, moveId: MOVES.psychic.special.psychic },
      ...
      },
      {
        name: ENTRENADORES.Chica.name, img: ENTRENADORES.Chica.img, rate: 40, pokemon: [
          { name: POKEMON.tangela, level: 36, moveId: MOVES.grass.physical.vine_whip },
        ]
      },
      {
        name: ENTRENADORES.Chica.name, img: ENTRENADORES.Chica.img, rate: 20, pokemon: [
          { name: POKEMON.xatu, level: 34, moveId: [MOVES.flying.special.gust, MOVES.psychic.special.psychic] },
          { name: POKEMON.tangela, level: 34, moveId: MOVES.grass.physical.vine_whip },
          { name: POKEMON.quagsire, level: 36, moveId: MOVES.ground.special.earth_power },
          { name: POKEMON.yanma, level: 37, moveId: MOVES.bug.physical.x_scissor },
        ]
      },
    ],
    pathLength: 5
    ...
    trainer: [
      {
        name: ENTRENADORES.Medium.name, img: ENTRENADORES.Medium.img, rate: 20, pokemon: [
          { name: POKEMON.haunter, level: 34, moveId: MOVES.ghost.special.astral_barrage },
          { name: POKEMON.haunter, level: 36, moveId: [MOVES.ghost.special.shadow_ball, MOVES.dark.special.dark_pulse] },
        ]
      },
      {
        name: ENTRENADORES.Medium.name, img: ENTRENADORES.Medium.img, rate: 20, pokemon: [
          { name: POKEMON.gastly, level: 33, moveId: MOVES.ghost.special.shadow_ball },
          { name: POKEMON.gastly, level: 33, moveId: MOVES.fire.special.flamethrower },
          { name: POKEMON.gastly, level: 33, moveId: MOVES.dark.special.dark_pulse },
          { name: POKEMON.gastly, level: 33, moveId: MOVES.poison.special.sludge_bomb },
        ]
      },
      {
        name: ENTRENADORES.Medium.name, img: ENTRENADORES.Medium.img, rate: 20, pokemon: [
          { name: POKEMON.haunter, level: 36, moveId: [MOVES.ghost.special.shadow_ball, MOVES.dark.special.dark_pulse], overrides: { ability: 'levitate' } },
        ]
      },
      {
        name: ENTRENADORES.Medium.name, img: ENTRENADORES.Medium.img, rate: 20, pokemon: [
      ...
      {
        name: ENTRENADORES.Medium.name, img: ENTRENADORES.Medium.img, rate: 20, pokemon: [
          { name: POKEMON.misdreavus, level: 35, moveId: MOVES.dark.special.dark_pulse },
          { name: POKEMON.misdreavus, level: 36, moveId: [MOVES.ghost.special.shadow_ball, MOVES.dark.special.dark_pulse], overrides: { ability: 'levitate' } },
        ]
      },
    ],
    gym: {
  ...
  'ruta-38': {
    ...
    wild: [
      { name: POKEMON.snubbull, rate: 20, minLv: 37, maxLv: 41, moveId: [MOVES.fairy.physical.play_rough, MOVES.normal.physical.hyper_fang] },
      { name: POKEMON.exeggcute, rate: 20, minLv: 37, maxLv: 41, moveId: [MOVES.grass.special.giga_drain, MOVES.psychic.special.confusion] },
      { name: POKEMON.miltank, rate: 20, minLv: 37, maxLv: 41, moveId: MOVES.normal.physical.hyper_fang },
      { name: POKEMON.tauros, rate: 20, minLv: 37, maxLv: 41, moveId: MOVES.normal.physical.extreme_speed },
      { name: POKEMON.magnemite, rate: 20, minLv: 37, maxLv: 41, moveId: MOVES.electric.special.thunder_shock },
    ],
    trainer: [
      {
        name: ENTRENADORES.Marinero.name, img: ENTRENADORES.Marinero.img, rate: 34, pokemon: [
          { name: POKEMON.wooper, level: 39, moveId: [MOVES.water.special.scald, MOVES.ground.special.earth_power] },
          { name: POKEMON.mr_mime, level: 40, moveId: MOVES.psychic.special.psychic },
        ]
      },
      {
        name: ENTRENADORES.Ornitologo.name, img: ENTRENADORES.Ornitologo.img, rate: 33, pokemon: [
          { name: POKEMON.doduo, level: 39, moveId: MOVES.flying.physical.wing_attack },
          { name: POKEMON.doduo, level: 38, moveId: MOVES.flying.physical.wing_attack },
          { name: POKEMON.doduo, level: 41, moveId: MOVES.flying.physical.brave_bird },
        ]
      },
      {
        name: ENTRENADORES.Chica.name, img: ENTRENADORES.Chica.img, rate: 33, pokemon: [
          { name: POKEMON.flaaffy, level: 40, moveId: MOVES.electric.special.thunder_shock },
          { name: POKEMON.skiploom, level: 38, moveId: MOVES.grass.special.solar_beam },
        ]
      },
    ]
  },
    ...
    trainer: [
      {
        name: ENTRENADORES.Marinero.name, img: ENTRENADORES.Marinero.img, rate: 25, pokemon: [
          { name: POKEMON.poliwhirl, level: 43, moveId: [MOVES.water.physical.crabhammer, MOVES.fighting.physical.close_combat] },
          { name: POKEMON.politoed, level: 42, moveId: MOVES.water.special.surf },
        ]
      },
      {
        name: ENTRENADORES.Ornitologo.name, img: ENTRENADORES.Ornitologo.img, rate: 25, pokemon: [
          { name: POKEMON.pidgeotto, level: 43, moveId: MOVES.flying.physical.wing_attack },
          { name: POKEMON.pidgeotto, level: 43, moveId: MOVES.flying.physical.wing_attack },
          { name: POKEMON.pidgeotto, level: 41, moveId: MOVES.flying.physical.wing_attack },
          { name: POKEMON.pidgeotto, level: 39, moveId: MOVES.flying.physical.wing_attack },
      ...
      },
      {
        name: ENTRENADORES.DomingueroFuego.name, img: ENTRENADORES.DomingueroFuego.img, rate: 25, pokemon: [
          { name: POKEMON.growlithe, level: 40, moveId: [MOVES.fire.physical.flare_blitz, MOVES.normal.physical.extreme_speed] },
          { name: POKEMON.growlithe, level: 38, moveId: [MOVES.fire.physical.flare_blitz, MOVES.normal.physical.extreme_speed] },
          { name: POKEMON.arcanine, level: 42, moveId: [MOVES.fire.physical.flare_blitz, MOVES.normal.physical.extreme_speed] },
        ]
      },
      {
        name: ENTRENADORES.Chica.name, img: ENTRENADORES.Chica.img, rate: 25, pokemon: [
          { name: POKEMON.marill, level: 44, moveId: [MOVES.water.physical.crabhammer, MOVES.fairy.physical.play_rough] },
        ]
      }
    ],
    paths: [
  ...
  'faro-ciudad-olivo-2': {
    ...
    specialTrainer: {
      name: "Colchonero Salgado", img: ENTRENADORES.Pensador.img, pokemon: [
        ...
        {
          name: POKEMON.pidgeotto, level: 44,
          shiny: true,
          heldItem: ITEM.choice_scarf,
        ...
        {
          name: POKEMON.misdreavus, level: 50,
          heldItem: ITEM.eviolite,
  ...
  'faro-ciudad-olivo-3': {
    ...
    wild: [
      {
        name: POKEMON.ampharos, rate: 100, minLv: 50, maxLv: 55, moveId: [MOVES.fairy.special.sparkling_aria, MOVES.electric.special.thunder],
        overrides: { evs: { hp: 32, def: 32, spd: 32, spe: 32, atk: 32 }, ability: 'levitate' },
      },
    ],
    trainer: [],
    ...
    trainer: [
      {
        name: ENTRENADORES.Karateka.name, img: ENTRENADORES.Karateka.img, rate: 25, pokemon: [
          { name: POKEMON.hitmonlee, level: 48, moveId: MOVES.fighting.physical.karate_chop },
        ]
      },
      {
        name: ENTRENADORES.Karateka.name, img: ENTRENADORES.Karateka.img, rate: 25, pokemon: [
          { name: POKEMON.hitmonchan, level: 48, moveId: MOVES.fighting.physical.karate_chop },
        ]
      },
      {
        name: ENTRENADORES.Karateka.name, img: ENTRENADORES.Karateka.img, rate: 25, pokemon: [
          { name: POKEMON.machoke, level: 47, moveId: MOVES.fighting.physical.close_combat },
        ]
      },
      {
        name: ENTRENADORES.Karateka.name, img: ENTRENADORES.Karateka.img, rate: 25, pokemon: [
  ...
  'ruta-29-noche': {
    ...
    title: 'Ruta 29 (Noche)',
    wild: [
      { name: POKEMON.aipom, rate: 40, minLv: 5, maxLv: 8, moveId: MOVES.normal.physical.tackle },
      { name: POKEMON.spearow, rate: 30, minLv: 5, maxLv: 8, moveId: [MOVES.normal.physical.tackle, MOVES.flying.physical.peck] },
      { name: POKEMON.pineco, rate: 20, minLv: 5, maxLv: 8, moveId: MOVES.bug.physical.bug_bite },
      { name: POKEMON.heracross, rate: 5, minLv: 5, maxLv: 8, moveId: [MOVES.bug.physical.bug_bite, MOVES.fighting.physical.karate_chop] },
      { name: POKEMON.exeggcute, rate: 5, minLv: 5, maxLv: 8, moveId: [MOVES.psychic.special.confusion, MOVES.grass.special.absorb] },
    ],
    trainer: [
      {
        name: ENTRENADORES.EntrenadorJoven.name, img: ENTRENADORES.EntrenadorJoven.img, rate: 33, pokemon: [
          { name: POKEMON.sentret, minLv: 4, maxLv: 7, moveId: MOVES.normal.physical.tackle },
        ]
      },
      {
        name: ENTRENADORES.EntrenadorJoven.name, img: ENTRENADORES.EntrenadorJoven.img, rate: 33, pokemon: [
          { name: POKEMON.sentret, minLv: 4, maxLv: 7, moveId: MOVES.normal.physical.tackle },
          { name: POKEMON.hoppip, minLv: 4, maxLv: 7, moveId: MOVES.grass.special.absorb },
        ]
      },
      {
        name: ENTRENADORES.EntrenadorJoven.name, img: ENTRENADORES.EntrenadorJoven.img, rate: 34, pokemon: [
          { name: POKEMON.sentret, minLv: 4, maxLv: 7, moveId: MOVES.normal.physical.tackle },
          { name: POKEMON.hoothoot, minLv: 4, maxLv: 7, moveId: MOVES.flying.special.gust },
        ]
      },
    ],
    pathLength: 4
  ...
  'torre-bellsprout': {
    ...
    wild: [
      { name: POKEMON.bellsprout, rate: 40, minLv: 8, maxLv: 11, moveId: [MOVES.grass.special.absorb, MOVES.poison.special.poison_powder] },
      { name: POKEMON.rattata, rate: 40, minLv: 8, maxLv: 11, moveId: MOVES.normal.physical.tackle },
      { name: POKEMON.gastly, rate: 20, minLv: 8, maxLv: 11, moveId: MOVES.ghost.special.hex },
    ],
    trainer: [
      {
        name: ENTRENADORES.Pensador.name, img: ENTRENADORES.Pensador.img, rate: 33, pokemon: [
          { name: POKEMON.bellsprout, minLv: 8, maxLv: 11, moveId: [MOVES.grass.special.absorb, MOVES.poison.special.poison_powder] },
        ]
      },
      {
        name: ENTRENADORES.Pensador.name, img: ENTRENADORES.Pensador.img, rate: 33, pokemon: [
          { name: POKEMON.bellsprout, minLv: 8, maxLv: 12, moveId: [MOVES.grass.special.absorb, MOVES.poison.special.poison_powder] },
          { name: POKEMON.hoothoot, minLv: 8, maxLv: 12, moveId: MOVES.flying.special.gust },
        ]
      },
      {
