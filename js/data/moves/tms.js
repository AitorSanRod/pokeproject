...
var TM_LIST = {
  ...
  'tm-bubble-beam': {
    ...
    moveId: 'bubble-beam',
    types: ['water'],
    pokemons: [POKEMON.mew, POKEMON.smeargle],
  ...
  'tm-surf': {
    ...
    moveId: 'surf',
    types: [],
    pokemons: [POKEMON.pikachu, POKEMON.rhydon, POKEMON.rhyhorn, POKEMON.mew, POKEMON.sentret, POKEMON.smeargle],
    desc: 'Enseña Surf.',
    sprite: MT_SPRITES.water,
    fallbackIcon: '💧',
  },
  'tm-aqua-jet': {
    ...
    moveId: 'aqua-jet',
    types: [],
    pokemons: [POKEMON.starmie, POKEMON.staryu, POKEMON.gyarados, POKEMON.kingler, POKEMON.krabby, POKEMON.smeargle],
  ...
  'tm-thunderbolt': {
    ...
    moveId: 'thunderbolt',
    types: ['electric'],
    pokemons: [POKEMON.rhydon, POKEMON.mew, POKEMON.porygon, POKEMON.porygon2, POKEMON.smeargle],
    desc: 'Enseña Rayo.',
  ...
  'tm-wild-charge': {
    id: 'tm-wild-charge',
    name: 'MT Voltio Cruel',
    moveId: 'wild-charge',
    types: ['electric'],
    pokemons: [POKEMON.mew, POKEMON.smeargle],
    desc: 'Enseña Voltio Cruel.',
    sprite: MT_SPRITES.electric,
    fallbackIcon: '⚡',
  },
  // ═══════════════════════════════════════════════════════════════════════
  ...
  'tm-icy-wind': {
    ...
    moveId: 'icy-wind',
    types: ['ice', 'water'],
    pokemons: [POKEMON.abra, POKEMON.kadabra, POKEMON.alakazam, POKEMON.gastly, POKEMON.haunter, POKEMON.gengar, POKEMON.mew, POKEMON.smeargle],
  ...
  'tm-ice-beam': {
    ...
    moveId: 'ice-beam',
    types: ['ice'],
    pokemons: [POKEMON.porygon, POKEMON.porygon2, POKEMON.dragonite, POKEMON.dragonair, POKEMON.dratini, POKEMON.mewtwo, POKEMON.mew, POKEMON.smeargle],
  ...
  'tm-ice-fang': {
    ...
    moveId: 'ice-fang',
    types: ['ice'],
    pokemons: [POKEMON.aerodactyl, POKEMON.rattata, POKEMON.raticate, POKEMON.nidoking, POKEMON.nidoqueen, POKEMON.gyarados, POKEMON.mew, POKEMON.smeargle],
  ...
  'tm-stomping-tantrum': {
    ...
    types: ['ground', 'rock'],
    pokemons: [POKEMON.charmander, POKEMON.charmeleon, POKEMON.charizard, POKEMON.mew, POKEMON.smeargle],
  ...
  'tm-earth-power': {
    ...
    moveId: 'earth-power',
    types: [],
    pokemons: [POKEMON.bulbasaur, POKEMON.ivysaur, POKEMON.venusaur, POKEMON.mewtwo, POKEMON.mew, POKEMON.chikorita, POKEMON.bayleef, POKEMON.meganium, POKEMON.smeargle],
  ...
  'tm-giga-drain': {
    ...
    moveId: 'giga-drain',
    types: ['grass'],
    pokemons: [POKEMON.mew, POKEMON.chikorita, POKEMON.bayleef, POKEMON.meganium, POKEMON.smeargle],
  ...
  'tm-metal-claw': {
    ...
    moveId: 'metal-claw',
    types: [],
    pokemons: [POKEMON.charmander, POKEMON.charmeleon, POKEMON.charizard, POKEMON.mew, POKEMON.totodile, POKEMON.croconaw, POKEMON.feraligatr, POKEMON.smeargle],
  ...
  'tm-facade': {
    ...
    moveId: 'facade',
    types: ['fighting'],
    pokemons: [POKEMON.kangaskhan, POKEMON.marowak, POKEMON.scyther, POKEMON.snorlax, POKEMON.dragonite, POKEMON.mew, POKEMON.smeargle],
    desc: 'Enseña Fachada',
  ...
  'tm-tri-attack': {
    ...
    types: [],
    pokemons: [POKEMON.porygon, POKEMON.porygon2, POKEMON.mew, POKEMON.aipom, POKEMON.smeargle],
  ...
  'tm-crunch': {
    ...
    moveId: 'crunch',
    types: ['dark'],
    pokemons: [POKEMON.kangaskhan, POKEMON.snorlax, POKEMON.gyarados, POKEMON.pinsir, POKEMON.squirtle, POKEMON.wartortle, POKEMON.blastoise, POKEMON.mew, POKEMON.totodile, POKEMON.croconaw, POKEMON.feraligatr, POKEMON.smeargle],
  ...
  'tm-snarl': {
    ...
    moveId: 'snarl',
    types: ['dark'],
    pokemons: [POKEMON.mew, POKEMON.smeargle, POKEMON.entei, POKEMON.crobat, POKEMON.togepi, POKEMON.togetic, POKEMON.ampharos, POKEMON.murkrow],
    desc: 'Enseña Alarido',
    sprite: MT_SPRITES.dark,
    fallbackIcon: '',
  },
