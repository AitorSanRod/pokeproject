...
var TM_LIST = {
  ...
  'tm-thunderbolt': {
    ...
    moveId: 'thunderbolt',
    types: ['electric'],
    pokemons: [POKEMON.rhydon, POKEMON.mew, POKEMON.porygon, POKEMON.porygon2],
    desc: 'Enseña Rayo.',
  ...
  'tm-earth-power': {
    ...
    moveId: 'earth-power',
    types: [],
    pokemons: [POKEMON.bulbasaur, POKEMON.ivysaur, POKEMON.venusaur, POKEMON.mewtwo, POKEMON.mew, POKEMON.chikorita, POKEMON.bayleef, POKEMON.meganium],
  ...
  'tm-giga-drain': {
    ...
    moveId: 'giga-drain',
    types: ['grass'],
    pokemons: [POKEMON.mew, POKEMON.chikorita, POKEMON.bayleef, POKEMON.meganium],
  ...
  'tm-metal-claw': {
    ...
    moveId: 'metal-claw',
    types: [],
    pokemons: [POKEMON.charmander, POKEMON.charmeleon, POKEMON.charizard, POKEMON.mew, POKEMON.totodile, POKEMON.croconaw, POKEMON.feraligatr],
  ...
  'tm-tri-attack': {
    ...
    types: [],
    pokemons: [POKEMON.porygon, POKEMON.porygon2, POKEMON.mew, POKEMON.aipom],
  ...
  'tm-crunch': {
    ...
    moveId: 'crunch',
    types: ['dark'],
    pokemons: [POKEMON.kangaskhan, POKEMON.snorlax, POKEMON.gyarados, POKEMON.pinsir, POKEMON.squirtle, POKEMON.wartortle, POKEMON.blastoise, POKEMON.mew, POKEMON.totodile, POKEMON.croconaw, POKEMON.feraligatr],
